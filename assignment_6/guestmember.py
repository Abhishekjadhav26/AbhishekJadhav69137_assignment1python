...
class GuestMember(LU.LibraryUser):
    ...
    def borrow_book(self, book):
        if self.get_borrowed_book_count() < self.borrow_limit:
            ...
            print("Guest borrowing limit reached.");
    ...
    def __str__(self):
        return f"GuestMember(member_id={self.get_member_id()}, member_name={self.member_name}, borrowed_books={self.get_borrowed_book_count()}, outstanding_fine={self.get_outstanding_fine()})";